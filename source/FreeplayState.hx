		...
		switch (FreeplaySelectState.freeplayCats[FreeplaySelectState.curCategory].toLowerCase())
			{
				...
				case 'extra':
					addWeek(['Avoidance', 'Above And Beyond', 'Bubble Gum', 'Beware', 'Denna', 'Double Trouble', 'Descenders', 'Dilemma', 'Dinner Time!', 'Funner', 'Forgotten', 'Heaven', 'Jealous', 'Jingle', 'Lost', 'Lovers', 'Lunar Harmony', 'Mystery', 'Outcast', 'Pullover', 'Rabid', 'Stardust', 'Trickery', 'Travelers Encounter', 'United', 'Upon The Stars', 'Who\'s That', 'What\'s It To You', 'Warrior'], 0, 0xff00c3ff, ['diego', 'fozghon', 'allison', 'dog', 'denna', 'him', 'sarah',  'denna', 'dinner-doggo', 'dinksie', 'kattie', 'foxy-gay', 'catherine', 'foxy-gay', 'fozghon', 'jamie-cute', 'luna', 'betty', 'sarah', 'gf-furry', 'sophie', 'dinksie-golden', 'foxy-hide', 'pico', 'foxy-gay', 'kattie', 'bf-pixel', 'jack', 'tankman']);
				case 'funny':
