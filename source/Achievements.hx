...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Not So Sly Now!",		        "Beat Foxy's Week on Hard with no Misses.",		    'weekfoxy_nomiss',		false],
		["Well Played",				    "Beat Sophie's Week on Hard with no Misses.",		'weeksophie_nomiss',	false],
		["Never Come Back Again...",	"Beat Sarah's Week on Hard with no Misses.",		'weeksarah_nomiss',     false],
		["Damn It! I Mean... Dang It!",	"Beat Denna's Week on Hard with no Misses.",		'weekdenna_nomiss',		false],
		["Wow. That Was Impressive!",	"Beat Kattie's Week on Hard with no Misses.",		'weekkattie_nomiss',	false],
