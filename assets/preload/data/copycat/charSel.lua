...
local song = 'roughTimes'; --If you want to have a song play while people are in this menu. Remove this line entirely if you don't want one.
...
local characterList = { -- The list of characters
	...
	{
		name = "foxy-gacha-player",
		displayName = "Gacha Foxy",
	},
	{
		name = "boykisser-player",
		displayName = "Boykisser",
	},
}
